...
var Slider = (function($) {
    ...
    var toggle = function(wich, visible) {
        if (visible === undefined) {
            ...
            if (visible)
                $(wich, currentSlide).slideDown(velocity);
            else
                $(wich, currentSlide).slideUp(velocity);
        }
    };
    ...
    var resize = function() {
        ...
        if (h > w)
            ...
            initialMargin = Math.floor((w - width) / 2);
